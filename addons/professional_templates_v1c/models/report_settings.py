...
class TemplateSettings(models.Model):
    ...
    def _default_so_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [('key', 'like', 'professional_templates_v1c.SO\_%\_document'),
    ...
    def _default_po_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [('key', 'like', 'professional_templates_v1c.PO\_%\_document'),
    ...
    def _default_rfq_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [('key', 'like', 'professional_templates_v1c.RFQ\_%\_document'),
             ('type', '=', 'qweb'),('name','=','TVA Template')],
            order='key asc',
            limit=1)
        return def_tpl or self.env.ref(
    ...
    def _default_dn_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [('key', 'like', 'professional_templates_v1c.DN\_%\_document'),
    ...
    def _default_pk_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [('key', 'like', 'professional_templates_v1c.PICK\_%\_document'),
             ('type', '=', 'qweb'),('name','=','100 miles (TVA) Template')],
            order='key asc',
            limit=1)
    ...
    def _default_inv_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [('key', 'like', 'professional_templates_v1c.INVOICE\_%\_document'),
    ...
    template_inv = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates_v1c.INVOICE\_%\_document' )]",
        required=False)
    template_so = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates_v1c.SO\_%\_document' )]",
        required=False)
    ...
    template_po = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates_v1c.PO\_%\_document' )]",
        required=False)
    ...
    template_rfq = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates_v1c.RFQ\_%\_document' )]",
        required=False)
    ...
    template_dn = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates_v1c.DN\_%\_document' )]",
        required=False)
    ...
    template_pk = fields.Many2one(
        ...
        domain=
        "[('type', '=', 'qweb'), ('key', 'like', 'professional_templates_v1c.PICK\_%\_document' )]",
        required=False)
