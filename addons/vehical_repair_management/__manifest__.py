# -*- coding: utf-8 -*-
{
    ...
    'depends': ['hr', 'sale_management', 'base', 'cpabooks_sequences'],
    'data': [
        ...
        'report/receipt.xml',
        'report/previous_receipt_template.xml',
        'data/service_sequence.xml',
        'data/plate_source_data.xml',
        'data/function_call.xml',
        'data/plate_cat_data.xml',
    ],
    'images': [
