...
class invoice(models.Model):
    ...
    def generate_printer_data(self):
        ...
        data = tpl._render_template(tpl.body_html,'account.move', self.ids, post_process=False)
...
class purchase(models.Model):
    ...
    def generate_printer_data(self):
        ...
        data = tpl._render_template(tpl.body_html, 'purchase.order', self.ids, post_process=False)
        self.printer_data = data
...
class picking(models.Model):
    ...
    def generate_printer_data(self):
        ...
        data = tpl._render_template(tpl.body_html, 'stock.picking', self.ids)
        self.printer_data = data
...
class sale(models.Model):
    ...
    def generate_printer_data(self):
        ...
        data = tpl._render_template(tpl.body_html, 'sale.order', self.ids)
        self.printer_data = data
