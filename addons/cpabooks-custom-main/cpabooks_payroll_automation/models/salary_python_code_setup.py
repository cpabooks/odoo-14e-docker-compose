            ...
            if self.salary_structure.name == 'Hourly Pay on Basic':
                for rule in get_all_attach_rules:
                    ...
                    if rule.name == 'Net Salary':
                        line_data[2]['propose_code'] = 'result = categories.BASIC + categories.ALW +categories.HOTSAL+categories.NOTSAL-categories.ABSENT+categories.LWP-categories.LWOP+categories.EXTRA-categories.DED'
