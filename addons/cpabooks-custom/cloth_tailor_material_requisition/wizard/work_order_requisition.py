...
class WorkorderRequestMaterialRequisition(models.TransientModel):
    _name = 'project.task.material.requisition.wizard'
    _description = 'Workorder Request Material Requisition Wizard'
    ...
    def create_custom_material_requisition(self):
        ...
        active_id = self.env['project.task'].browse(context.get('active_id', False))
        ...
        action['context'] = {
            ...
            'default_custom_workorder_request_id' : active_id.id,
        }
        return action
