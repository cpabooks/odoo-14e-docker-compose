...
class RecipeStructure(models.AbstractModel):
    _name = 'report.cpabooks_dedicated_samurai.production_recipe_structure'
    _description = 'Production Recipe Structure Report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {'recipe': 'Here Recipe Will Print...'}
