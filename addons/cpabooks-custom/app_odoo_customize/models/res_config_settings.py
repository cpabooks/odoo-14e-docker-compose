...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='https://www.cpabooks.org/documentation/user/13.0/zh_CN/index.html')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='https://www.cpabooks.org/documentation/13.0/index.html')
        app_support_url = ir_config.get_param('app_support_url', default='https://www.cpabooks.org/trial/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='https://www.cpabooks.org/my-account/')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='https://www.cpabooks.org')
        app_ribbon_name = ir_config.get_param('app_ribbon_name', default='*Sunpop.cn')
        res.update(
            app_system_name='CPAbooks',
            ...
            app_documentation_url='https://www.cpabooks.org',
            app_documentation_dev_url='https://www.cpabooks.org',
            app_support_url='https://www.cpabooks.org',
            app_account_title=app_account_title,
            app_account_url='https://www.cpabooks.org',
            app_enterprise_url='https://www.cpabooks.org',
            app_ribbon_name='False'
        )
        return res
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_support_url", self.app_support_url or "https://www.cpabooks.org/trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "https://www.cpabooks.org/my-account/")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "https://www.cpabooks.org")
    ...
    #         self.env['res.config.settings'].sudo().execute()
