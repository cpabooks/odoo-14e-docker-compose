...
class BudgetCustomerLine(models.Model):
    _name = 'budget.customer.line'
    _description = 'Budget Customer Line'
    ...
    actual_cy_partner = fields.Many2one('res.partner', 'Actual CY', domain=[('customer_rank', '>', 0)])
    actual_ly_partner_id = fields.Many2one('res.partner', 'Actual LY', domain=[('customer_rank', '>', 0)], compute='_set_partner')
    payment_cyp_partner = fields.Many2one('res.partner', 'Payment CYP', domain=[('customer_rank', '>', 0)], compute='_set_partner')
    budget_cy_partner = fields.Many2one('res.partner', 'Budget CY', domain=[('customer_rank', '>', 0)], compute='_set_partner')
    budget_ly_partner = fields.Many2one('res.partner', 'Budget LY', domain=[('customer_rank', '>', 0)], compute='_set_partner')
